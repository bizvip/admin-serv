    ...
    public function up(): void
    {
        Schema::create('setting_generate_columns', function (Blueprint $table) {
            ...
            $table->addColumn('string', 'column_type', ['length' => 50, 'comment' => '字段类型'])
                ->nullable();
            $table->addColumn('smallInteger', 'is_pk', [
                'default' => 1,
                'comment' => '1 非主键 2 主键',
            ])->nullable();
            $table->addColumn('smallInteger', 'is_required', [
                'default' => 1,
                'comment' => '1 非必填 2 必填',
            ])->nullable();
            $table->addColumn('smallInteger', 'is_insert', [
                'default' => 1,
                'comment' => '1 非插入字段 2 插入字段',
            ])->nullable();
            $table->addColumn('smallInteger', 'is_edit', [
                'default' => 1,
                'comment' => '1 非编辑字段 2 编辑字段',
            ])->nullable();
            $table->addColumn('smallInteger', 'is_list', [
                'default' => 1,
                'comment' => '1 非列表显示字段 2 列表显示字段',
            ])->nullable();
            $table->addColumn('smallInteger', 'is_query', [
                'default' => 1,
            ...
            $table->addColumn('string', 'options', ['length' => 1000, 'comment' => '字段其他设置'])
                ->nullable();
            $table->addColumn('string', 'extra', ['length' => 255, 'comment' => '字段扩展信息'])
                ->nullable();
