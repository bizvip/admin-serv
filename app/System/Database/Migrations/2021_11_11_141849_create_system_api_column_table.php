...
class CreateSystemApiColumnTable extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('system_api_column', function (Blueprint $table) {
            ...
            $table->addColumn('bigInteger', 'api_id', [
                'unsigned' => true,
                'comment' => '接口主键',
            ]);
            $table->addColumn('string', 'name', ['length' => 64, 'comment' => '字段名称']);
            $table->addColumn('smallInteger', 'type', [
                'default' => 1,
            ...
            $table->addColumn('string', 'default_value', ['length' => 500, 'comment' => '默认值'])
                ->nullable();
            $table->addColumn('smallInteger', 'status', [
                'default' => 1,
                'comment' => '状态 (1正常 2停用)',
            ])->nullable();
            $table->addColumn('string', 'description', ['length' => 500, 'comment' => '字段说明'])
                ->nullable();
